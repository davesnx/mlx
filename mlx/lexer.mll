...
let prepare_error loc = function
  ...
  | Empty_character_literal ->
      ...
      let sub =
        [Location.msg
           "@{<hint>Hint@}: Did you mean ' ' or a type variable 'a?"
        ] in
  ...
  | Capitalized_label lbl ->
      Location.errorf ~loc
        "'%s' cannot be used as label name, \
         it must start with a lowercase letter" lbl
  | Invalid_literal s ->
  ...
  | Capitalized_raw_identifier lbl ->
      Location.errorf ~loc
        "'%s' cannot be used as a raw identifier, \
         it must start with a lowercase letter" lbl
  | Non_lowercase_delimiter name ->
      Location.errorf ~loc
        "'%s' cannot be used as a quoted string delimiter,@ \
         it must contain only lowercase letters." name
  | Unknown_keyword name ->
      Location.errorf ~loc
      "'%s' has been defined as an additional keyword.@ \
       This version of OCaml does not support this keyword." name
